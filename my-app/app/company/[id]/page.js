...
export default function CompanyDetails() {
  ...
  return (
    <Box maxWidth="1000px" mx="auto" bgcolor="#fff" p={5} borderRadius={3} boxShadow={3}>
      ...
      {/* About */}
      <Box mb={4}>
        <Typography variant="h5" fontWeight="600" gutterBottom>About</Typography>
      ...
      {/* Location */}
      <Box mb={4}>
        <Typography variant="h5" fontWeight="600" gutterBottom>Location</Typography>
      ...
      {/* Industry */}
      <Box mb={4}>
        <Typography variant="h5" fontWeight="600" gutterBottom>Industry</Typography>
      ...
      {/* Timeline */}
      <Box mb={4}>
        <Typography variant="h5" fontWeight="600" gutterBottom>Company Timeline</Typography>
      ...
      {/* Other Info */}
      <Box mb={2}>
        <Typography variant="h5" fontWeight="600" gutterBottom>Other Info</Typography>
